...
docker build -t topicmanagementservice-mono -f $(dirname "$0")/docker/mono/Dockerfile.mono .

echo "Deploying container..."
docker stack deploy -c $(dirname "$0")/docker/mono/docker-compose-mono.yml topicmanagementstack